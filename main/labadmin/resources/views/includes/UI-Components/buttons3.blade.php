...
@foreach ($buttons as $item)
    <li class="inline-block m-0.5">
        <a href="" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent {{ $item['style'] }} rounded-full">{{ $item['title'] }}</a>
    </li>
@endforeach