        ...
        <div class="grid grid-cols-1 mt-8">
            ...
            <div class="group relative p-6 shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 rounded-xl hover:shadow-xl transition-all duration-500 border-l-4 border-blue-600 mb-8">
                <div class="flex items-start justify-between">
                    <!-- Publication Image -->
                    <div class="w-20 h-20 bg-blue-100 rounded-lg mr-4 flex-shrink-0 flex items-center justify-center mt-0 md:mt-12" style="margin-top: 48px">
                    ...
                    <div class="flex flex-col gap-2 ml-6">
                        @if($publication->url)
                        <a href="{{ $publication->url }}" target="_blank" class="size-10 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center bg-blue-600 hover:bg-blue-700 text-white rounded-full" title="View Publication">
