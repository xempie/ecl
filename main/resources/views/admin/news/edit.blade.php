...
<div class="container-fluid relative px-3">
    <div class="layout-specing">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h5 class="text-xl font-bold">Edit News Article</h5>
                <h6 class="text-slate-400 font-semibold">Update news article details</h6>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.news.update', $news) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
                            <div>
                                ...
                                <input id="title" name="title" type="text" value="{{ old('title', $news->title) }}" 
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            <div>
                                ...
                                @if($news->image)
                                    <div class="mt-2 mb-2">
                                        <img src="{{ asset('storage/' . $news->image) }}" class="h-20 w-20 object-cover rounded-md" alt="Current image">
                            ...
                            <div>
                                ...
                                <input id="published_date" name="published_date" type="datetime-local" 
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            <div>
                                ...
                                <textarea id="excerpt" name="excerpt" rows="3"
                                          ...
                                          placeholder="Brief description of the news article">{{ old('excerpt', $news->excerpt) }}</textarea>
                                @error('excerpt')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="author" name="author" type="text" value="{{ old('author', $news->author) }}"
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-2">
                                <textarea id="content" name="content" 
                                          class="tinymce-editor @error('content') border-red-500 @enderror" 
                                          placeholder="Write the full content of the news article..." required>{{ old('content', $news->content) }}</textarea>
                            </div>
                            @error('content')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            <div>
                                ...
                                <textarea id="meta_description" name="meta_description" rows="2" 
                                          ...
                                          placeholder="SEO meta description">{{ old('meta_description', $news->meta_description) }}</textarea>
                            ...
                            <div>
                                ...
                                <input id="meta_keywords" name="meta_keywords" type="text" value="{{ old('meta_keywords', $news->meta_keywords) }}" 
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            <button type="submit" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Update News</button>
                        </div>
                    </form>
                </div>
            </div>
