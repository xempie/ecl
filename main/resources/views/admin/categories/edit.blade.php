...
<div class="container-fluid relative px-3">
    <div class="layout-specing">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h5 class="text-xl font-bold">Edit Research Topic</h5>
                <h6 class="text-slate-400 font-semibold">Update research topic for publications and projects</h6>
            </div>
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.categories') }}" class="py-[7px] px-6 font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-gray-100 hover:bg-gray-200 border-gray-200 text-gray-700 rounded-md">
                    <i class="uil uil-arrow-left"></i> Back to Research Topics
                </a>
            </div>
        </div>
        ...
        <div class="mt-6">
            <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="max-w-2xl">
                ...
                <div class="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6">
                    <h6 class="text-lg font-semibold mb-6">Research Topic Details</h6>

                    <div class="grid grid-cols-1 gap-6">
                        <!-- Name -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Research Topic Name *</label>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                                <p class="text-sm text-gray-500 mt-1">Choose a color to represent this research topic</p>
                            </div>
                            <div>
                                <label for="position_order" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Display Order</label>
                                <input type="number" id="position_order" name="position_order" value="{{ old('position_order', $category->position_order) }}" min="0"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_active" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Active Research Topic</label>
                        </div>
                        ...
                        <div class="flex space-x-3">
                            <button type="submit" 
                                ...
                                <i class="uil uil-check"></i> Update Research Topic
                            </button>
