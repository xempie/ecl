                    ...
                    <div class="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $member->title) }}" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                @error('title')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <select id="member_category" name="member_category" required
                                ...
                                @foreach(\App\Models\Member::getMemberCategories() as $key => $value)
                                    <option value="{{ $key }}" {{ old('member_category', $member->member_category) === $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
