...
<div class="container-fluid relative px-3">
    <div class="layout-specing">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h5 class="text-xl font-bold">Add New Member</h5>
                <h6 class="text-slate-400 font-semibold">Create a new team member profile</h6>
            </div>
        ...
        <!-- Form -->
        <div class="mt-6">
            <form method="POST" action="{{ route('admin.members.store') }}" enctype="multipart/form-data" class="grid lg:grid-cols-3 grid-cols-1 gap-6">
                @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="bio" name="bio" rows="4"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('bio') }}</textarea>
                                @error('bio')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="research_interests" name="research_interests" rows="3"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('research_interests') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="qualifications" name="qualifications" rows="3"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('qualifications') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="achievements" name="achievements" rows="3"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('achievements') }}</textarea>
                                @error('achievements')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6 mt-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="url" id="social_linkedin" name="social_linkedin" value="{{ old('social_linkedin') }}"
                            ...
                            <div>
                                ...
                                <input type="email" id="social_email" name="social_email" value="{{ old('social_email') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                @error('social_email')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="url" id="social_website" name="social_website" value="{{ old('social_website') }}"
                            ...
                            <div>
                                ...
                                <input type="url" id="social_google_scholar" name="social_google_scholar" value="{{ old('social_google_scholar') }}"
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6 mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="lab_location" name="lab_location" required
                                ...
                                <option value="auckland" {{ old('lab_location') === 'auckland' ? 'selected' : '' }}>Auckland Lab</option>
                                <option value="adelaide" {{ old('lab_location') === 'adelaide' ? 'selected' : '' }}>Adelaide Lab</option>
                                <option value="director" {{ old('lab_location') === 'director' ? 'selected' : '' }}>Director</option>
                            </select>
                            @error('lab_location')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6">
                        <button type="submit" 
                            ...
                            <i class="uil uil-check"></i> Create Member
                        </button>
                    </div>
                </div>
            </form>
