...
<div class="container-fluid relative px-3">
    <div class="layout-specing">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h5 class="text-xl font-bold">Create Event</h5>
                <h6 class="text-slate-400 font-semibold">Add a new event or activity</h6>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            <div>
                                ...
                                <input id="event_location" name="event_location" type="text" value="{{ old('event_location') }}" 
                            ...
                            <div>
                                ...
                                <input id="event_url" name="event_url" type="url" value="{{ old('event_url') }}" 
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="excerpt" name="excerpt" rows="3" 
                                      ...
                                      placeholder="Brief description of the event">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-2">
                                <textarea id="content" name="content" 
                                          ...
                                          placeholder="Write the detailed description of the event..." required>{{ old('content') }}</textarea>
                            </div>
                            @error('content')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            <button type="submit" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Create Event</button>
                        </div>
                    </form>
                </div>
            </div>
