...
@foreach ($experiences as $item)
    <div class="flex duration-500 hover:scale-105 shadow-sm dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 ease-in-out items-center p-4 rounded-md bg-white dark:bg-slate-900 mt-6">
        <img src="{{ asset($item['img']) }}" class="size-16 p-4 bg-slate-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-700 rounded-md" alt="">
