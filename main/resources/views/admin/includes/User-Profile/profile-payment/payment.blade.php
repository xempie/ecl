...
$payments = [
    ...
    [
        ...
        'date' => 'Expires in 12/2025',
        'style' => 'flex justify-between items-center py-6 border-t border-gray-100 dark:border-gray-700',
    ],
    [
...
@foreach ($payments as $item)
    <li class="{{ $item['style'] }}">
        <div class="flex items-center">
            <img src="{{ asset($item['img']) }}" class="rounded shadow-sm dark:shadow-gray-700 w-12" alt="">
