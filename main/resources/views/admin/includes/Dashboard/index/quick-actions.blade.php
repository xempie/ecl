...
<div class="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
    ...
    <div class="p-6">
        <div class="grid grid-cols-2 gap-4">
            <!-- Add Member -->
            <a href="{{ route('admin.members.create') }}" class="flex flex-col items-center p-4 border border-gray-100 dark:border-gray-800 rounded-md hover:border-blue-600 hover:shadow-sm transition-all duration-300">
            ...
            <!-- Add Publication -->
            <a href="{{ url('/labadmin/publications/create') }}" class="flex flex-col items-center p-4 border border-gray-100 dark:border-gray-800 rounded-md hover:border-emerald-600 hover:shadow-sm transition-all duration-300">
            ...
            <!-- Add Project -->
            <a href="{{ url('/labadmin/projects/create') }}" class="flex flex-col items-center p-4 border border-gray-100 dark:border-gray-800 rounded-md hover:border-violet-600 hover:shadow-sm transition-all duration-300">
            ...
            <!-- Add News -->
            <a href="{{ url('/labadmin/news/create') }}" class="flex flex-col items-center p-4 border border-gray-100 dark:border-gray-800 rounded-md hover:border-amber-600 hover:shadow-sm transition-all duration-300">
        ...
        <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
            <div class="grid grid-cols-1 gap-3">
                <a href="{{ url('/labadmin/contact-messages') }}" class="flex items-center justify-between p-3 border border-gray-100 dark:border-gray-800 rounded-md hover:border-red-600 hover:shadow-sm transition-all duration-300">
                ...
                <a href="{{ url('/labadmin/settings/general') }}" class="flex items-center p-3 border border-gray-100 dark:border-gray-800 rounded-md hover:border-gray-400 hover:shadow-sm transition-all duration-300">
