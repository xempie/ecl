<!-- resources/views/blog-slider-post.blade.php -->
@extends('layouts.main')

@section('title', 'Blog-Slider-Post Page')
                ...
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                    <div class="relative">
                        <div class="tiny-single-item">
                            <div class="tiny-slide"><img src="{{ asset('assets/images/blog/01.jpg') }}" class="rounded-md" alt=""></div>
                            <div class="tiny-slide"><img src="{{ asset('assets/images/blog/02.jpg') }}" class="rounded-md" alt=""></div>
                            <div class="tiny-slide"><img src="{{ asset('assets/images/blog/03.jpg') }}" class="rounded-md" alt=""></div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-12">
                        ...
                        <h3 class="my-3 text-[26px] font-semibold">The Morning After: Uber sets its sights on Postmates</h3>
