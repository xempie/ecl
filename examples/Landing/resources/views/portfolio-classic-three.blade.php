<!-- resources/views/portfolio-classic-three.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Classic-Three Page')
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-classic-three/classic-three.blade.php -->
            @include('includes.Portfolio.portfolio-classic-three.classic-three')
