<!-- resources/views/blog-gallery-post.blade.php -->
@extends('layouts.main')

@section('title', 'Blog-Gallery-Post Page')
            ...
            <div class="lg:col-span-8 md:col-span-6">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                    ...
                    <div id="grid" class="md:flex justify-center mx-auto">
                        ...
                        <!-- includes/Pages/Blog/Blog-Posts/blog-gallery-post/post3.blade.php -->
                        @include('includes.Pages.Blog.Blog-Posts.blog-gallery-post.post3')

                    </div>

                    <div class="text-center mt-12">
                        <span class="bg-indigo-600 inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Photography</span>
                        <h3 class="my-3 text-[26px] font-semibold">Get Ready To Up Your <br> Creative Game With The New DJI Mavic Air 2</h3>
