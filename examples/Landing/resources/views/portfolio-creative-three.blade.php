<!-- resources/views/portfolio-creative-three.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Creative-Three Page')
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex w-full justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-creative-three/creative-three.blade.php -->
            @include('includes.Portfolio.portfolio-creative-three.creative-three')
