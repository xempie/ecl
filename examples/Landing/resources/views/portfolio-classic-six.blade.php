<!-- resources/views/portfolio-classic-six.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Classic-Six Page')
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-classic-six/classic-six.blade.php -->
            @include('includes.Portfolio.portfolio-classic-six.classic-six')
