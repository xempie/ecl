<!-- resources/views/page-job-candidates.blade.php -->
@extends('layouts.main')

@section('title', 'Page-Job-Candidates Page')
...
<section class="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800">
    <div class="container relative">
        <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[30px]">
            ...
            <!-- includes/Pages/Job-Careers/page-job-candidates/candidate.blade.php -->
            @include('includes.Pages.Job-Careers.page-job-candidates.candidate')
