<!-- resources/views/portfolio-classic-four.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Classic-Four Page')
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-classic-four/classic-four.blade.php -->
            @include('includes.Portfolio.portfolio-classic-four.classic-four')
