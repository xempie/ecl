<!-- resources/views/portfolio-masonry-five.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Masonry-Five Page')
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-masonry-five/masonry-five.blade.php -->
            @include('includes.Portfolio.portfolio-masonry-five.masonry-five')
