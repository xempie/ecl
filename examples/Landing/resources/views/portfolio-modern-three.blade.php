<!-- resources/views/portfolio-modern-three.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Modern-Three Page')
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-modern-three/modern-three.blade.php -->
            @include('includes.Portfolio.portfolio-modern-three.modern-three')
