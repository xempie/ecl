<!-- resources/views/blog-youtube-post.blade.php -->
@extends('layouts.main')

@section('title', 'Blog-Youtube-Post Page')
            ...
            <div class="lg:col-span-8 md:col-span-6">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                    ...
                    <div class="relative overflow-hidden rounded-md">
                        <iframe src="https://www.youtube.com/embed/S_CGed6E610?feature=oembed" class="w-full" allow="autoplay; encrypted-media" style="height: 433px;" allowfullscreen=""></iframe>
                    </div>

                    <div class="text-center mt-12">
                        <span class="bg-indigo-600 inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Youtube</span>
                        <h3 class="my-3 text-[26px] font-semibold">Techwind - Tailwind CSS Landing Page Template</h3>
