<!-- resources/views/nft-explore.blade.php -->
@extends('layouts.main')

@section('title', 'Nft-Explore Page')
...
<section class="relative table w-full py-32 lg:py-40 bg-gradient-to-br to-orange-600/20 via-fuchsia-600/20 from-indigo-600/20">
    <div class="container relative">
        <div class="grid grid-cols-1 text-center mt-10">
            <h3 class="text-3xl leading-normal font-medium">Explore Items</h3>
        </div><!--end grid-->
    </div><!--end container-->
    ...
    <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
        <ul class="tracking-[0.5px] mb-0 inline-block">
            ...
            <li class="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><i class="uil uil-angle-right-b"></i></li>
            <li class="inline-block uppercase text-[13px] font-bold text-indigo-600" aria-current="page">Explore Items</li>
        </ul>
    </div>
</section><!--end section-->
<div class="relative">
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Landings/nft-explore/bid.blade.php -->
            @include('includes.Landings.nft-explore.bid')

        </div><!--end grid-->

        <div class="grid md:grid-cols-12 grid-cols-1 mt-6">
            <div class="md:col-span-12 text-center">
                <a href="" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"><i class="uil uil-process mdi-spin"></i> Load More</a>
            </div>
        </div><!--end grid-->
    </div><!--end container-->
</section><!--end section-->
