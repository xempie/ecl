...
@section('title', 'user-invoice Page')
        ...
        <div class="md:flex justify-center mt-24">
            <div class="lg:w-4/5 w-full">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900">
                        ...
                        <div class="mt-3 md:w-56">
                            <ul class="list-none">
                                <li class="flex mt-3">
                                    ...
                                    <span class="text-slate-400">21th March, 2025</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    
                    <div class="relative overflow-x-auto shadow-sm dark:shadow-gray-800 rounded-md mt-6">
                        <table class="w-full text-start text-slate-500 dark:text-slate-400">
                            ...
                            <tbody>
                                ...
                                <!-- includes/Pages/Accounts/user-invoice/items.blade.php -->
                                @include('includes.Pages.Accounts.user-invoice.items')
                    ...
                    <div class="invoice-footer border-t border-gray-100 dark:border-gray-800 pt-6">
                        <div class="md:flex justify-between">
                            <div>
                            ...
                            <div class="mt-4 md:mt-0">
                                <div class="text-slate-400 text-center md:text-end">
                                    <h6 class="mb-0"><a href="{{ url('/page-terms') }}" target="_blank" class="text-indigo-600">Terms & Conditions</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
