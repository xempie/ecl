<!-- resources/views/portfolio-modern-five.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Modern-Five Page')
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-modern-five/modern-five.blade.php -->
            @include('includes.Portfolio.portfolio-modern-five.modern-five')
