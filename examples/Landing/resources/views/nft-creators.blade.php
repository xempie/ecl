<!-- resources/views/nft-creators.blade.php -->
@extends('layouts.main')

@section('title', 'Nft-Creators Page')
...
<section class="relative table w-full py-32 lg:py-40 bg-gradient-to-br to-orange-600/20 via-fuchsia-600/20 from-indigo-600/20">
    <div class="container relative">
        <div class="grid grid-cols-1 text-center mt-10">
            <h3 class="text-3xl leading-normal font-medium">Creators</h3>
        </div><!--end grid-->
    </div><!--end container-->
    ...
    <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
        <ul class="tracking-[0.5px] mb-0 inline-block">
            ...
            <li class="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><i class="uil uil-angle-right-b"></i></li>
            <li class="inline-block uppercase text-[13px] font-bold text-indigo-600" aria-current="page">Creators</li>
        </ul>
    </div>
</section><!--end section-->
<div class="relative">
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        <div class="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
            ...
            <!-- includes/Landings/nft-creators/creators.blade.php -->
            @include('includes.Landings.nft-creators.creators')
