<!-- resources/views/portfolio-modern-six.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Modern-Six Page')
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-modern-six/modern-six.blade.php -->
            @include('includes.Portfolio.portfolio-modern-six.modern-six')
