<!-- resources/views/blog-vimeo-post.blade.php -->
@extends('layouts.main')

@section('title', 'Blog-Vimeo-Post Page')
    ...
    <div class="container relative">
        <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            <div class="lg:col-span-8 md:col-span-6">
                <div class="p-6 pt-0 rounded-md shadow-sm dark:shadow-gray-800">
                    <iframe src="https://player.vimeo.com/video/99025203" class="w-full" allow="autoplay; encrypted-media" style="height: 433px;" allowfullscreen=""></iframe>

                    <div class="text-center mt-12">
                        <span class="bg-indigo-600 inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Vimeo</span>
                        <h3 class="my-3 text-[26px] font-semibold">The power of video at your fingertips</h3>
