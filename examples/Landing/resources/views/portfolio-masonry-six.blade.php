<!-- resources/views/portfolio-masonry-six.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Masonry-Six Page')
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-masonry-six/masonry-six.blade.php -->
            @include('includes.Portfolio.portfolio-masonry-six.masonry-six')
