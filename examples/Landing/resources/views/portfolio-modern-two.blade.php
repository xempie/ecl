<!-- resources/views/portfolio-modern-two.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Modern-Two Page')
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex lg:w-3/4 w-full justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-modern-two/modern-two.blade.php -->
            @include('includes.Portfolio.portfolio-modern-two.modern-two')
