<!-- resources/views/blog-left-sidebar-post.blade.php -->
@extends('layouts.main')

@section('title', 'Blog-Left-Sidebar-Post Page')
...
<section class="relative md:pb-24 md:pt-40 pb-16 pt-36">
    <div class="container relative">
        <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            <div class="lg:col-span-8 md:col-span-6 order-1 md:order-2">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-800">

                    <img src="{{ asset('assets/images/blog/03.jpg') }}" class="rounded-md" alt="">
            ...
            <div class="lg:col-span-4 md:col-span-6 order-2 md:order-1">
