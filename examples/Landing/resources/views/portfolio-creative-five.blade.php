<!-- resources/views/portfolio-creative-five.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Creative-Five Page')
...
<section class="relative table w-full py-32 lg:py-40 bg-no-repeat bg-center bg-cover" style="background-image: url('{{ asset('assets/images/portfolio/bg-inner.jpg') }}');">
    ...
    <div class="container relative">
        <div class="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <p class="text-slate-300 text-lg max-w-xl mx-auto">Showcase of Our Awesome Works in Five Columns</p>
        </div><!--end grid-->
    </div><!--end container-->
    ...
    <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
        <ul class="tracking-[0.5px] mb-0 inline-block">
            ...
            <li class="inline-block text-base text-white/50 mx-0.5 ltr:rotate-0 rtl:rotate-180"><i class="uil uil-angle-right-b"></i></li>
            <li class="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">Creative</li>
        </ul>
    </div>
</section><!--end section-->
<div class="relative">
...
<section class="relative md:py-24 py-16">
        ...
        <div class="grid grid-cols-1 items-center gap-[30px]">
            <div class="filters-group-wrap text-center">
                <div class="filters-group">
                    ...
                    <!-- includes/Portfolio/portfolio-creative-two/filters-group5.blade.php -->
                    @include('includes.Portfolio.portfolio-creative-two.filters-group5')
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex w-full justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-creative-five/creative-five.blade.php -->
            @include('includes.Portfolio.portfolio-creative-five.creative-five')
