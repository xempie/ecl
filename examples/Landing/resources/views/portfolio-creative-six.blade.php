<!-- resources/views/portfolio-creative-six.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Creative-Six Page')
...
<section class="relative table w-full py-32 lg:py-40 bg-no-repeat bg-center bg-cover" style="background-image: url('{{ asset('assets/images/portfolio/bg-inner.jpg') }}');">
    ...
    <div class="container relative">
        <div class="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <p class="text-slate-300 text-lg max-w-xl mx-auto">Showcase of Our Awesome Works in Six Columns</p>
        </div><!--end grid-->
    </div><!--end container-->
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex w-full justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-creative-six/creative-six.blade.php -->
            @include('includes.Portfolio.portfolio-creative-six.creative-six')
