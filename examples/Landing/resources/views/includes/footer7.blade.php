<!-- Footer Start -->
<footer class="relative text-gray-400 dark:text-gray-400 top left" style="background-image: url('{{ asset('assets/images/photography/footer.jpg') }}');">
    <div class="absolute inset-0 bg-gradient-to-r to-transparent via-white dark:via-slate-900 from-white dark:from-slate-900"></div>
