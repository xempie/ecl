<div class="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
    <div class="relative">
        <img src="{{ asset('assets/images/app/classic04.png') }}" class="mx-auto" alt="">
        <div class="overflow-hidden absolute lg:size-[400px] size-[320px] bg-indigo-600/5 bottom-2/4 translate-y-2/4 start-0 rotate-45 -z-1 shadow-md shadow-indigo-600/10 rounded-[100px]"></div>
    </div>
