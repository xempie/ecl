<div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
    <div class="relative order-1 md:order-2">
        ...
        <div class="overflow-hidden absolute lg:size-[400px] size-[320px] bg-indigo-600/5 bottom-2/4 translate-y-2/4 end-0 rotate-45 -z-1 shadow-md shadow-indigo-600/10 rounded-[100px]"></div>
    </div>
