<div class="grid md:grid-cols-12 grid-cols-1 items-center">
    ...
    <div class="lg:col-span-7 md:col-span-6">
        ...
        <div class="my-5">
            <a href=""><img src="{{ asset('assets/images/app/app.png') }}" class="m-1 inline-block" alt=""></a>

            <a href=""><img src="{{ asset('assets/images/app/playstore.png') }}" class="m-1 inline-block" alt=""></a>
        </div>

        <div class="inline-block">
            <div class="pt-4 flex items-center border-t border-gray-100 dark:border-gray-800">
                <i data-feather="smartphone" class="me-2 text-indigo-600 size-10"></i>
                <div class="content">
