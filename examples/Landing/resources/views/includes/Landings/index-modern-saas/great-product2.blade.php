<div class="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
    <div class="relative">
        <img src="{{ asset('assets/images/saas/classic02.png') }}" class="rounded-lg shadow-md dark:shadow-gray-800" alt="">
        <div class="overflow-hidden absolute lg:size-[400px] size-[320px] bg-indigo-600/5 dark:bg-indigo-600/20 bottom-0 start-0 rotate-45 -z-1 rounded-3xl"></div>
    </div>
