...
<div class="hidden relative overflow-hidden" id="friday" role="tabpanel" aria-labelledby="friday-tab">
    ...
    <div class="absolute inset-0 bg-center bg-cover opacity-5" style="background-image: url('{{ asset('assets/images/yoga/bg.jpg') }}');"></div>
</div>