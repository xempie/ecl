...
<div class="hidden relative overflow-hidden" id="tuesday" role="tabpanel" aria-labelledby="tuesday-tab">
    ...
    <div class="absolute inset-0 bg-center bg-cover opacity-5" style="background-image: url('{{ asset('assets/images/yoga/ab02.jpg') }}');"></div>
</div>