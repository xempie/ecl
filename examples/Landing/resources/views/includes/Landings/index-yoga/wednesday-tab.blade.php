...
<div class="hidden relative overflow-hidden" id="wednesday" role="tabpanel" aria-labelledby="wednesday-tab">
    ...
    <div class="absolute inset-0 bg-center bg-cover opacity-5" style="background-image: url('{{ asset('assets/images/yoga/ab03.jpg') }}');"></div>
</div>