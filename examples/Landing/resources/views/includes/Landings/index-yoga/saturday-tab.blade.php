...
<div class="hidden relative overflow-hidden" id="saturday" role="tabpanel" aria-labelledby="saturday-tab">
    ...
    <div class="absolute inset-0 bg-center bg-cover opacity-5" style="background-image: url('{{ asset('assets/images/yoga/i11.jpg') }}');"></div>
</div>