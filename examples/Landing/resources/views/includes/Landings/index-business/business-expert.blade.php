<div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
    <div class="md:col-span-5">
        <div class="relative">
            <img src="{{ asset('assets/images/business/about01.jpg') }}" class="rounded-md" alt="">

            <div class="absolute bottom-24 end-0">
                <img src="{{ asset('assets/images/business/about02.jpg') }}" class="rounded-md shadow-md size-48" alt="">
                <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                    <a href="#!" data-type="youtube" data-id="S_CGed6E610"
                        class="lightbox size-14 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600">
