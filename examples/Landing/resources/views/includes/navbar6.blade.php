    ...
    <div class="container relative">
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu nav-light nav-right !justify-end">
                <li><a href="{{ url('/index-video') }}" class="sub-menu-item">Home</a></li>
        
                <li><a href="{{ url('/video-portfolio') }}" class="sub-menu-item">Videos</a></li>
                <li><a href="javascript:void(0)" class="sub-menu-item">Studio</a></li>
                <li><a href="{{ url('/contact-two') }}" class="sub-menu-item">Contact Us</a></li>
