...
<nav id="topnav" class="defaultscroll is-sticky">
    <div class="container relative">
        ...
        <a class="logo ps-0" href="{{ url('/') }}">
            <img src="{{ asset('assets/images/logo-icon-30.png') }}" class="inline-block sm:hidden"  alt="">
        ...
        <ul class="buy-button list-none mb-0">
            ...
            <li class="inline-block mb-0">
                <div class="form-icon relative">
                    ...
                    <input type="text" class="form-input sm:w-44 w-28 ps-10 py-2 px-3 h-10 dark:bg-slate-900 dark:text-slate-200 rounded-3xl outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 bg-white" name="s" id="searchItem" placeholder="Search...">
                </div>
            </li>
    
            <li class="inline-block ps-1 mb-0">
                <a id="connectWallet" class="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><i class="uil uil-wallet"></i></a>
            </li>
            ...
            <li class="dropdown inline-block relative ps-1">
                ...
                <div class="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 hidden" onclick="event.stopPropagation();">
                    <div class="relative">
                        ...
                        <div class="absolute px-4 -bottom-7 start-0">
                            <div class="flex items-end">
                                <img src="{{ asset('assets/images/client/05.jpg') }}" class="rounded-full size-10 shadow-sm dark:shadow-gray-700" alt="">
                    ...
                    <ul class="py-2 text-start">
                        <li>
                            <a href="{{ url('/nft-creator-profile') }}" class="block text-[14px] font-semibold py-1.5 px-4 hover:text-indigo-600"><i class="uil uil-user text-[16px] align-middle me-1"></i> Profile</a>
                        </li>
                        <li>
                            <a href="{{ url('/nft-creator-profile-edit') }}" class="block text-[14px] font-semibold py-1.5 px-4 hover:text-indigo-600"><i class="uil uil-setting text-[16px] align-middle me-1"></i> Settings</a>
                        </li>
                        <li class="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                        <li>
                            <a href="{{ url('/auth-login') }}" class="block text-[14px] font-semibold py-1.5 px-4 hover:text-indigo-600"><i class="uil uil-sign-out-alt text-[16px] align-middle me-1"></i> Logout</a>
                        </li>
                    </ul>
                </div>
            </li>
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu nav-left !justify-start">
                <li><a href="{{ url('/index-nft') }}" class="sub-menu-item">Home</a></li>
