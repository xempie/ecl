<!-- resources/views/page-team.blade.php -->
@extends('layouts.main')

@section('title', 'Page-Team Page')
...
<!-- Start Hero -->
<section class="relative table w-full py-36 lg:py-44 bg-no-repeat bg-center bg-cover" style="background-image: url('{{ asset('assets/images/team.jpg') }}');">
...
<section class="relative md:py-24 py-16">
    ...
    <div class="container relative md:mt-24 mt-16">
        ...
        <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-8 gap-[30px]">
            ...
            <!-- includes/Pages/Company/page-team/team4.blade.php -->
            @include('includes.Pages.Company.page-team.team4')
