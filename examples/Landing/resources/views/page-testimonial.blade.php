<!-- resources/views/page-testimonial.blade.php -->
@extends('layouts.main')

@section('title', 'Page-Testimonial Page')
...
<section class="relative table w-full py-36 lg:py-44 bg-no-repeat bg-center bg-cover" style="background-image: url('{{ asset('assets/images/services.jpg') }}');">
    ...
    <div class="container relative">
        <div class="grid grid-cols-1 pb-8 text-center mt-10">
            <h5 class="text-white/50 text-lg font-medium">Testimonial</h5>
            <h3 class="mt-2 md:text-4xl text-3xl md:leading-normal leading-normal font-medium text-white">Client's Review</h3>
        </div><!--end grid-->
    </div><!--end container-->
    ...
    <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
        <ul class="tracking-[0.5px] mb-0 inline-block">
            ...
            <li class="inline-block text-base text-white/50 mx-0.5 ltr:rotate-0 rtl:rotate-180"><i class="uil uil-angle-right-b"></i></li>
            <li class="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">Testimonial</li>
        </ul>
    </div>
</section><!--end section-->
<div class="relative">
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Pages/Company/page-testimonial/reviews9.blade.php -->
            @include('includes.Pages.Company.page-testimonial.reviews9')
