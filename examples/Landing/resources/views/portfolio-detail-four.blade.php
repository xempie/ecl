<!-- resources/views/portfolio-detail-four.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Detail-Four Page')
        ...
        <div class="grid grid-cols-1">
            <div class="tiny-single-item">
                <div class="tiny-slide">
                    <div class="m-2">
                        <img src="{{ asset('assets/images/portfolio/16.jpg') }}" class="rounded-md shadow-sm dark:shadow-gray-800" alt="">
                    </div>
                </div>
                <div class="tiny-slide">
                    <div class="m-2">
                        <img src="{{ asset('assets/images/portfolio/17.jpg') }}" class="rounded-md shadow-sm dark:shadow-gray-800" alt="">
                    </div>
                </div>
                <div class="tiny-slide">
                    <div class="m-2">
                        <img src="{{ asset('assets/images/portfolio/18.jpg') }}" class="rounded-md shadow-sm dark:shadow-gray-800" alt="">
                    </div>
                </div>
            </div>
        </div>
