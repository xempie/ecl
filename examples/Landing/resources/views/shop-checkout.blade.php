...
@section('title', 'Shop-Checkout Page')
    ...
    <div class="container relative">
        ...
        <div class="relative mt-3">
            <ul class="tracking-[0.5px] mb-0 inline-block">
                ...
                <li class="inline-block uppercase text-[13px] font-bold text-indigo-600" aria-current="page">Checkout</li>
            </ul>
        </div>
    </div><!--end container-->
</section><!--end section-->
        ...
        <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 gap-[30px]">
            ...
            <div class="lg:col-span-4">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                    ...
                    <div class="mt-4 rounded-md shadow-sm dark:shadow-gray-800">
                    ...
                    <div class="subcribe-form mt-6">
                        <form class="relative max-w-xl">
                            <input type="email" id="subcribe" name="email" class="py-4 pe-40 ps-6 w-full h-[50px] outline-none text-slate-900 dark:text-white rounded-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800" placeholder="Promo code">
