<!-- resources/views/portfolio-classic-five.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Classic-Five Page')
...
<section class="relative md:py-24 py-16">
        ...
        <div class="grid grid-cols-1 items-center gap-[30px]">
            <div class="filters-group-wrap text-center">
                <div class="filters-group">
                    ...
                    <!-- includes/Portfolio/portfolio-classic-two/filters-group4.blade.php -->
                    @include('includes.Portfolio.portfolio-classic-two.filters-group4')
    ...
    <div class="container-fluid relative">
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-classic-five/classic-five.blade.php -->
            @include('includes.Portfolio.portfolio-classic-five.classic-five')
