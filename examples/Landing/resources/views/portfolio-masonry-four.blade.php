<!-- resources/views/portfolio-masonry-four.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Masonry-Four Page')
...
<section class="relative md:py-24 py-16">
    <div class="container relative">
        ...
        <div id="grid" class="md:flex justify-center mx-auto mt-4">
            ...
            <!-- includes/Portfolio/portfolio-masonry-four/masonry-four.blade.php -->
            @include('includes.Portfolio.portfolio-masonry-four.masonry-four')
