        ...
        <div class="grid md:grid-cols-12 grid-cols-1 mt-6 gap-6">
            <div class="lg:col-span-8 md:col-span-6">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                    ...
                    <img src="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/images/blog/bg.jpg') }}" class="rounded-md" alt="">
                ...
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 mt-6">
                    <h5 class="text-lg font-semibold">Comments:</h5>

                    <!-- includes/Blog/blog-detail/comments.blade.php -->
                    @include('includes.Blog.blog-detail.comments')
            ...
            <div class="lg:col-span-4 md:col-span-6">
                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                    <h5 class="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-700 rounded-md p-2 text-center">Author</h5>
                    ...
                    <h5 class="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-700 rounded-md p-2 text-center mt-6">Recent post</h5>

                        <!-- includes/Blog/blog-detail/recent.blade.php -->
                        @include('includes.Blog.blog-detail.recent')

                    <h5 class="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-700 rounded-md p-2 text-center mt-6">Social sites</h5>
                    ...
                    <h5 class="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-700 rounded-md p-2 text-center mt-6">Tagscloud</h5>
                    <ul class="list-none text-center mt-6 space-x-2">
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Business</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Finance</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Marketing</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Fashion</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Bride</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Lifestyle</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Travel</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Beauty</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Video</a></li>
                        <li class="inline-block my-2"><a href="" class="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700 duration-500">Audio</a></li>
                    </ul>
                </div>
            </div>
        </div><!--end grid-->
