    ...
    <div class="header-bar flex justify-between">
        <div class="flex items-center space-x-1">
            ...
            <div class="ps-1.5">
                <div class="form-icon relative sm:block hidden">
                    ...
                    <input type="text" class="form-input w-56 ps-9 py-2 px-3 h-8 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-3xl outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" name="s" id="searchItem" placeholder="Search...">
                </div>
            </div>
            <!-- Searchbar -->
        </div>
        ...
        <ul class="list-none mb-0 space-x-1">
            ...
            <li class="dropdown inline-block relative">
                ...
                <!-- Dropdown menu -->
                <div class="dropdown-menu absolute start-0 m-0 mt-4 z-10 w-36 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 hidden" onclick="event.stopPropagation();">
                    <ul class="list-none py-2 text-start">
                        <li class="my-1">
                            <a href="" class="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-indigo-600 dark:hover:text-white"><img src="{{ asset('assets/images/flags/germany.png') }}" class="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""> German</a>
                        </li>
                        <li class="my-1">
                            <a href="" class="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-indigo-600 dark:hover:text-white"><img src="{{ asset('assets/images/flags/italy.png') }}" class="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""> Italian</a>
                        </li>
                        <li class="my-1">
                            <a href="" class="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-indigo-600 dark:hover:text-white"><img src="{{ asset('assets/images/flags/russia.png') }}" class="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""> Russian</a>
                        </li>
                        <li class="my-1">
                            <a href="" class="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-indigo-600 dark:hover:text-white"><img src="{{ asset('assets/images/flags/spain.png') }}" class="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""> Spanish</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="dropdown inline-block relative">
                <button data-dropdown-toggle="dropdown" class="dropdown-toggle size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[20px] text-center bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-100 dark:border-gray-800 text-slate-900 dark:text-white rounded-full" type="button">
                    ...
                    <span class="absolute top-0 end-0 flex items-center justify-center bg-emerald-600 text-white text-[10px] font-bold rounded-full size-2 after:content-[''] after:absolute after:size-2 after:bg-emerald-600 after:top-0 after:end-0 after:rounded-full after:animate-ping"></span>
                </button>
                <!-- Dropdown menu -->
                <div class="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-60 rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 hidden" onclick="event.stopPropagation();">
                    <ul class="py-3 text-start" aria-labelledby="dropdownDefault">
                        <li>
                            <a href="#" class="flex items-center justify-between py-1.5 px-4">
                                <span class="flex items-center">
                                    <img src="{{ asset('assets/images/shop/items/s1.jpg') }}" class="rounded shadow-sm dark:shadow-gray-700 w-9" alt="">
                                    <span class="ms-3">
                        ...
                        <li>
                            <a href="#" class="flex items-center justify-between py-1.5 px-4">
                                <span class="flex items-center">
                                    <img src="{{ asset('assets/images/shop/items/s2.jpg') }}" class="rounded shadow-sm dark:shadow-gray-700 w-9" alt="">
                                    <span class="ms-3">
                        ...
                        <li>
                            <a href="#" class="flex items-center justify-between py-1.5 px-4">
                                <span class="flex items-center">
                                    <img src="{{ asset('assets/images/shop/items/s3.jpg') }}" class="rounded shadow-sm dark:shadow-gray-700 w-9" alt="">
                                    <span class="ms-3">
